        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 relative">
          ...
          >
            <div className="flex items-center justify-center md:justify-start space-x-3 mb-4">
              <HiOutlinePhone className="w-6 h-6 mainColor" />
              <h3 className="text-xl text-gray-900">Contact Us</h3>
            </div>
            <div className="space-y-2">
              <div>
                <span className="font-semibold text-gray-900">Email: </span>
                <span className="text-gray-600">thesaloncompany@gmail.com</span>
              </div>
              <div>
            ...
            {/* Line separator only on large screens */}
          ...
          >
            <div className="flex items-center justify-center md:justify-start space-x-3 mb-4">
              <HiOutlineLocationMarker className="w-6 h-6 mainColor" />
          ...
          >
            <div className="flex items-center justify-center md:justify-start space-x-3 mb-4">
              <HiOutlineClock className="w-6 h-6 mainColor" />
