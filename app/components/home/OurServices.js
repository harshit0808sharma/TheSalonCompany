  ...
  return (
    <section className="bg-[#f9f6f7] py-16 px-4 md:px-12">
      ...
      <div className="text-center mt-16 px-6">
        <h3 className="text-2xl md:text-3xl font-bold text-[#214037] flex items-center justify-center gap-2">
          <FaRegCalendarAlt className="text-teal-700" />
          {currentCategory.cta}
        </h3>
        <p className="mt-4">
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 bg-[#214037] text-white px-6 py-3 rounded-full shadow-md hover:bg-[#28554E] transition"
          >
