...
export default function Team() {
  const { teamMembersData, theme } = useContext(SalonContext);

  return (
    <>
      <div className="max-w-[1920px] m-auto p-0 md:p-5 mainBg2">
        <section
          className={`py-28 rounded-none md:rounded-4xl transition-colors duration-500 mainBg1 relative`}
        >
          <AnimateImageLeft/>
          {/* Heading */}
          <div className="text-center max-w-3xl mx-auto mb-12 leading-snug">
            <div className="flex justify-center items-center gap-2">
              ...
              />
              <span
                className={`font-medium ${theme ? "text-teal-400" : "text-teal-800"
                  }`}
              >
                Our Team
              </span>
            ...
            <Heading
              Text={"Meet Our Expert Team: Masters of Beauty & Confidence"}
            />
          ...
          {/* Team Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 max-w-7xl mx-auto p-4">
