...
export default function AboutSection() {
  ...
  return (
    <section
      className={`py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-32 flex flex-col gap-6 sm:gap-8 md:gap-10 transition-colors duration-300 mainBg2`}
    >
        ...
        <div className="relative order-2 lg:order-1">
          ...
          >
            <Image
              src={image1}
              alt="Doctor"
              className="w-full max-w-xs sm:max-w-sm md:max-w-md mx-auto lg:mx-0 h-auto object-cover rounded-4xl"
            />
          </motion.div>

          <motion.div
            className={`absolute -bottom-6 sm:-bottom-8 md:-bottom-10 right-2 sm:right-4 md:right-8 w-1/2 sm:w-2/3 md:w-2/3 h-2/5 rounded-4xl overflow-hidden shadow-lg border-4 sm:border-6 md:border-8 ${
          ...
          <motion.a
            ...
            className={`absolute top-4 sm:top-6 md:top-10 right-2 sm:right-4 md:right-12 lg:right-20 w-20 h-20 sm:w-28 sm:h-28 md:w-36 md:h-36 flex items-center gap-1 sm:gap-2 justify-center rounded-full border-4 sm:border-6 md:border-8 text-xs sm:text-sm text-center font-medium shadow-lg spin-slow ${
              theme
          ...
          <div className="flex items-center gap-2">
            ...
            <span
              className={`font-medium text-sm sm:text-base ${
                theme ? "text-teal-300" : "text-[#264D45]"
              }`}
            >
              About Us
            </span>
          ...
          <div className="flex flex-col xl:flex-row items-stretch gap-6 sm:gap-8 w-full">
            ...
            <div className="flex flex-col space-y-4 sm:space-y-6 md:space-y-8 lg:space-y-10 w-full xl:w-2/3">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full">
                <Link
                  href="/about"
                  className={`px-4 sm:px-6 py-2.5 sm:py-3 rounded-full flex items-center justify-center gap-2 transition text-sm sm:text-base w-full sm:w-auto flex-shrink-0 ${
                    theme
                ...
                <button
                  onClick={handleClick}
                  className={`px-4 sm:px-6 py-2.5 sm:py-3 rounded-full font-bold flex items-center justify-center gap-2 transition text-sm sm:text-base border w-full sm:w-auto flex-shrink-0 ${
                    theme
            ...
            {/* Right Team Count */}
            <motion.div
              className={`rounded-4xl px-6 sm:px-8 md:px-10 py-6 sm:py-8 flex gap-2 flex-col items-center justify-center shadow-lg w-full xl:w-1/3 h-auto min-h-[160px] sm:min-h-[180px] md:min-h-[200px] ${
                theme ? "bg-gray-800 text-white" : "bg-[#264D45] text-white"
              }`}
