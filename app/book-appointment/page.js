  ...
  const stagger = {
    ...
    return (
        <>
            ...
            <section className="bg-[#faf7f7] py-16 px-6">
                <div className="max-w-4xl mx-auto text-center">
                    {/* Section Header */}
                    <p className="text-teal-800 font-medium mb-2">• Book An Appointment</p>
                    <h2 className="text-4xl font-semibold text-teal-900 mb-4">
                        Schedule your appointment
                    </h2>
                    <p className="text-gray-600 max-w-2xl mx-auto mb-10">
                        It’s time to take control of your skin health! Booking your appointment is
                        easy and fast. Choose a time that works for you and our dermatology
                    ...
                    >
                        ...
                        <div className="md:col-span-2 flex justify-center">
                            <button
                                type="submit"
                                className="bg-teal-800 text-white px-8 py-3 rounded-lg hover:bg-teal-900 transition shadow"
                            >
                                Send Message
                            </button>
                        </div>
