...
export const teamMembersData = [
  {
    ...
    about: [
      "Dr. Kristin Watson has over a decade of experience in skincare and salon treatments.",
      "She specializes in dermatology and advanced skin rejuvenation techniques.",
    ],
    knowAbout:
      "Kristin Watson is committed to helping clients achieve radiant skin using safe and effective salon dermatology treatments.",
    expertise: [
      { label: "Skin Health", value: 85 },
      { label: "Cosmetic Care", value: 90 },
      { label: "Hair & Makeup", value: 92 },
    ],
  },
  {
    slug: "jacob-jones",
    ...
    about: [
      "Dr. Jacob Jones is a cosmetic expert with a focus on beauty treatments.",
      "He offers customized plans for glowing skin, anti-aging, and salon cosmetics.",
    ],
    knowAbout:
      "Jacob Jones blends modern cosmetic dermatology with salon aesthetics to provide outstanding results.",
    expertise: [
      { label: "Skin Glow", value: 88 },
      { label: "Makeup & Styling", value: 95 },
      { label: "Anti-Aging", value: 90 },
    ],
  },
  {
    slug: "emily-clark",
    name: "Dr. Emily Clark",
    position: "Hair & Beauty Specialist",
    email: "emily@salon.com",
    phone: "+91 9988776655",
    experience: "8 years",
    image: "/assets/images/salon-person4.jpg",
    about: [
      "Emily Clark is passionate about salon hair care and skin beauty solutions.",
      "Her friendly approach makes clients feel confident and cared for.",
    ],
    knowAbout:
      "Emily specializes in salon hair treatments, skincare, and beauty enhancements tailored to each client.",
    expertise: [
      { label: "Hair Styling", value: 90 },
      { label: "Skin Treatments", value: 85 },
      { label: "Beauty & Makeup", value: 80 },
    ],
  },
  // ✅ New Member
  {
    ...
    about: [
      "Dr. Priya Sharma is an aesthetic specialist with expertise in facial treatments and salon beauty care.",
      "She is known for her personalized approach to enhancing natural beauty.",
    ],
    knowAbout:
      "Priya Sharma focuses on non-invasive aesthetic treatments, ensuring clients achieve flawless beauty with confidence.",
    expertise: [
      { label: "Facial Aesthetics", value: 92 },
      { label: "Beauty Treatments", value: 87 },
      { label: "Client Care", value: 95 },
    ],
  },
];
